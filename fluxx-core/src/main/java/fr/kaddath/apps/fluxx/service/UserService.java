...
public class UserService {
	...
	public List<Fluxxer> findByFeed(Feed feed) {
		...
		String strQuery = "select * from AGGREGATEDFEED_FEED, FLUXXER, AGGREGATEDFEED where FLUXXER.USERNAME = AGGREGATEDFEED.FLUXXER_USERNAME and AGGREGATEDFEED_FEED.AGGREGATEDFEED_ID = AGGREGATEDFEED.ID and AGGREGATEDFEED_FEED.FEED_ID ="
				+ feed.getId();
