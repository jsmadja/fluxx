...
public class RssServiceTest extends AbstractTest {
    ...
    public void withPodcast() throws Exception {
        ...
        String rss = rssService.getRssFeedById(aggregatedFeed.getAggregatedFeedId(), request, "UTF-8");
    ...
    public void withCategory() throws DownloadFeedException {
        ...
        String rss = rssService.getRssFeedById(feed.getAggregatedFeedId(), request, "UTF-8");
